...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_naive" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2be28bdd#;
   pragma Export (C, u00001, "test_naiveB");
   ...
   u00175 : constant Version_32 := 16#21332da0#;
   pragma Export (C, u00175, "google_naiveB");
   u00176 : constant Version_32 := 16#db02366e#;
   pragma Export (C, u00176, "google_naiveS");
   u00177 : constant Version_32 := 16#e31b7c4e#;
