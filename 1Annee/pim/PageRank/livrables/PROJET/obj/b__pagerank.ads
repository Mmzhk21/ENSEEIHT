...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#39532e8e#;
   ...
   u00177 : constant Version_32 := 16#a9b72214#;
   pragma Export (C, u00177, "google_creuseB");
   u00178 : constant Version_32 := 16#5b378fa5#;
   pragma Export (C, u00178, "google_creuseS");
   u00179 : constant Version_32 := 16#2fe0a0be#;
   pragma Export (C, u00179, "vecteurs_creuxB");
   u00180 : constant Version_32 := 16#70e42ea5#;
   pragma Export (C, u00180, "vecteurs_creuxS");
   u00181 : constant Version_32 := 16#21332da0#;
   pragma Export (C, u00181, "google_naiveB");
   u00182 : constant Version_32 := 16#db02366e#;
   pragma Export (C, u00182, "google_naiveS");
