...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_paa" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#bb16096f#;
   pragma Export (C, u00001, "paaB");
   ...
   u00177 : constant Version_32 := 16#e4ada122#;
   pragma Export (C, u00177, "google_naiveB");
   u00178 : constant Version_32 := 16#1e9cbaec#;
   pragma Export (C, u00178, "google_naiveS");
