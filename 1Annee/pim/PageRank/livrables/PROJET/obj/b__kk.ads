...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_kk" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#40de0651#;
   pragma Export (C, u00001, "kkB");
   ...
   u00177 : constant Version_32 := 16#21332da0#;
   pragma Export (C, u00177, "google_naiveB");
   u00178 : constant Version_32 := 16#db02366e#;
